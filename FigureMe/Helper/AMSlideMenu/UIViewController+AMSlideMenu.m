...
- (void)addRightMenuButton
{
    ...
    UIButton *rightNotiBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [mainVC configureRightNotificationButton:rightNotiBtn];
    [rightNotiBtn addTarget:mainVC action:@selector(openNotifications) forControlEvents:UIControlEventTouchUpInside];
    
    navItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:rightBtn];
    //navItem.rightBarButtonItems = [NSArray arrayWithObjects:rightBtn,rightNotiBtn, nil];
